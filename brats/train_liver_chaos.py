...
config["all_modalities"] = ["DICOM_anon"]
...
config["data_file"] = os.path.abspath("liver_chaos_data.h5")
config["model_file"] = os.path.abspath("liver_chaos_model.h5")
config["training_file"] = os.path.abspath("training_chaos_liver_ids.pkl")
config["validation_file"] = os.path.abspath("validation_chaos_liver_ids.pkl")
