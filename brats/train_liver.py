...
config["model_file"] = os.path.abspath("liver_model.h5")
config["training_file"] = os.path.abspath("training_liver_ids.pkl")
config["validation_file"] = os.path.abspath("validation_liver_ids.pkl")
config["overwrite"] = False  # If True, will previous files. If False, will use previously written files.


def fetch_training_data_files():
    training_data_files = list()
    for subject_dir in glob.glob(os.path.join(os.path.dirname(__file__), "data", "prep-liver", "*")):
        subject_files = list()
